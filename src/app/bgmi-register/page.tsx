...
export default function BgmiRegisterPage() {
    ...
    return (
        <>
            <Head>
                <title>BGMI Tournament - INFINITY</title>
                <meta name="description" content="Register for the INFINITY BGMI Tournament. Choose from Solo, Duo, or Squad mode." />
            </Head>
            <header className="py-32 lg:py-40 bg-black text-center" data-ai-hint="battle royale game map">
                <div className="container mx-auto px-4">
                    <h1 className="font-headline text-4xl md:text-6xl font-bold">BGMI <span className="text-accent">Tournament</span></h1>
                    <p className="mt-4 text-lg md:text-xl max-w-3xl mx-auto text-muted-foreground">This is a Squads Only tournament with ₹69 entry fee per person. Choose your preferred mode and compete in our upcoming BGMI tournaments.</p>
                ...
                <div className="container mx-auto px-4">
                    <div className="text-center max-w-4xl mx-auto mb-16">
                        ...
                        <p className="mt-4 text-lg text-muted-foreground">
                            Welcome to the ultimate battleground! Get ready to showcase your skills in this thrilling BGMI tournament.
                        </p>
                    </div>

                    <div className="max-w-6xl mx-auto bg-background/50 border border-primary/20 rounded-2xl p-8">
                        <div className="prose prose-invert max-w-none">
                            <h3 className="font-headline text-2xl text-accent mb-6">BGMI Tournament Rules</h3>
